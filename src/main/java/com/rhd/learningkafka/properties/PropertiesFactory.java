...
public class PropertiesFactory {
    ...
    public static Properties buildAsProducer() {
        ...
        properties.setProperty(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka_b:9092");
    ...
    public static Properties buildOpenSearchWikimediaConsumer(Boolean manual) {
        ...
        properties.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "kafka_b:9092");        
